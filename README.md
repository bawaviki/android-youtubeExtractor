...
* Builds:![](https://jitpack.io/v/bawaviki/android-youtubeExtractor.svg)](https://jitpack.io/#bawaviki/android-youtubeExtractor)
...
```java	
implementation 'com.github.bawaviki:android-youtubeExtractor:Tag'
	}
```
